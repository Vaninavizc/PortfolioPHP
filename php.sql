...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 19 Mars 2020 à 19:30
...
INSERT INTO `profile` (`NumProfil`, `Nom`, `Paragra1`, `UrlPhoto`, `website`) VALUES
('1', 'Marie', 'J''aime Harry Styles plus que ma vie', 'https://mir-s3-cdn-cf.behance.net/user/276/880ea2221910083.5ca8f96740622.jpg', 'http://mariegoursaud.fr/'),
('2', 'Clélia', 'j''aime les ratons-laveurs plus que les êtres humains', 'http://cleliaguyon.com/img/me.jpg', 'http://cleliaguyon.com'),
('3', 'Vanina', 'J''aime le Pays-Basque plus que ma vie', 'https://scontent-cdg2-1.xx.fbcdn.net/v/t1.0-9/61474870_1318961888253507_8832952861039001600_n.jpg?_nc_cat=108&_nc_sid=85a577&_nc_oc=AQkwBpiheZcxBew9FlvlOsWqNuvw64L3gMtgQO0LtzNjtYVFJG_flPO30J2keo1Z5rk&_nc_ht=scontent-cdg2-1.xx&oh=5aa0b5f0f60267a29fee1150f442ee5f&oe=5E9A4573', 'http://vaninaidiart.fr');
...
CREATE TABLE IF NOT EXISTS `projet` (
  `NumPro` int(4) NOT NULL AUTO_INCREMENT,
